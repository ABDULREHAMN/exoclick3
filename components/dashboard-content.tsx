...
export function DashboardContent({ onNavigate }: DashboardContentProps) {
  ...
  const availableBalance = 6280.97
  const pendingBalance = 1410.00
  const thisMonthEarnings = 4208.00
  const lastMonthEarnings = 2910.11
  const totalPayments = 1585.18
  const totalEarnings = 9506.85
  ...
  const recentActivityData = [
    { date: "Apr 09, 2026", impressions: 18281, clicks: 2215, revenue: 532.00, ctr: "12.12%", ecpm: "481.02" },
  ]
  ...
  const todayRevenue = 532.00
  const todayImpressions = 18281
  const todayClicks = 2215
  const todayCTR = "12.12"
  const todayECPM = "481.02"
  ...
  const displayTotalRevenue = 9506.85 // April update Apr 8-9
  const displayTotalClicks = 38021 // Updated total
  const displayTotalImpressions = 1155371 // Updated total
