...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Mar 29, 2026", impressions: "4,280", clicks: "190", ctr: "4.44%", ecpm: "$93.31", revenue: "$28.31" },
        { date: "Mar 28, 2026", impressions: "12,280", clicks: "325", ctr: "2.65%", ecpm: "$87.97", revenue: "$82.35" },
        { date: "Mar 27, 2026", impressions: "12,380", clicks: "341", ctr: "2.75%", ecpm: "$85.54", revenue: "$83.31" },
        ...
        { date: "Mar 24, 2026", impressions: "12,480", clicks: "331", ctr: "2.65%", ecpm: "$85.66", revenue: "$83.31" },
        { date: "Mar 23, 2026", impressions: "12,880", clicks: "331", ctr: "2.57%", ecpm: "$83.90", revenue: "$83.91" },
        { date: "Mar 22, 2026", impressions: "12,400", clicks: "310", ctr: "2.50%", ecpm: "$83.87", revenue: "$82.32" },
