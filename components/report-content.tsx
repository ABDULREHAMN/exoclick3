...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 05, 2026", impressions: "9,280", clicks: "915", ctr: "9.86%", ecpm: "$470.00", revenue: "$80.00" },
        ...
        { date: "Mar 29, 2026", impressions: "12,880", clicks: "345", ctr: "2.68%", ecpm: "$93.31", revenue: "$83.31" },
