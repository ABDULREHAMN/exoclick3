...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 02, 2026", impressions: "10,120", clicks: "780", ctr: "7.71%", ecpm: "$210.00", revenue: "$46.30" },
        ...
        { date: "Mar 26, 2026", impressions: "12,380", clicks: "349", ctr: "2.82%", ecpm: "$90.41", revenue: "$83.31" },
