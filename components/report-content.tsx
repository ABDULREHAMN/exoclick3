...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 03, 2026", impressions: "10,780", clicks: "835", ctr: "7.75%", ecpm: "$315.00", revenue: "$41.31" },
        ...
        { date: "Mar 27, 2026", impressions: "12,300", clicks: "341", ctr: "2.77%", ecpm: "$86.76", revenue: "$81.31" },
