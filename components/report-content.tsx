...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 04, 2026", impressions: "11,280", clicks: "910", ctr: "8.07%", ecpm: "$415.00", revenue: "$70.00" },
        ...
        { date: "Mar 28, 2026", impressions: "12,280", clicks: "325", ctr: "2.65%", ecpm: "$87.97", revenue: "$82.35" },
