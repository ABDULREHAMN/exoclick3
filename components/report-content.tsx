...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 21, 2026", impressions: "4,280", clicks: "315", ctr: "7.36%", ecpm: "$340.00", revenue: "$70.00" },
        { date: "Apr 20, 2026", impressions: "16,280", clicks: "730", ctr: "4.48%", ecpm: "$375.00", revenue: "$172.40" },
