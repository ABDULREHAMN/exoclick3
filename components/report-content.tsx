...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Mar 2, 2026", impressions: "8,434", clicks: "254", ctr: "3.01%", ecpm: "$89.55", revenue: "$59.77" },
        { date: "Mar 1, 2026", impressions: "13,425", clicks: "365", ctr: "2.72%", ecpm: "$82.23", revenue: "$81.55" },
