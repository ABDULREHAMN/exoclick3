...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Mar 14, 2026", impressions: "12,332", clicks: "102", ctr: "0.83%", ecpm: "$82.31", revenue: "$30.11" },
        { date: "Mar 12, 2026", impressions: "13,873", clicks: "321", ctr: "2.31%", ecpm: "$81.22", revenue: "$82.22" },
