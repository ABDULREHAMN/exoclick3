...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 26, 2026", impressions: "4,569", clicks: "100", ctr: "2.19%", ecpm: "$360.00", revenue: "$45.00" },
        { date: "Apr 25, 2026", impressions: "12,280", clicks: "344", ctr: "2.80%", ecpm: "$120.00", revenue: "$145.00" },
