...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Mar 3, 2026", impressions: "4,561", clicks: "167", ctr: "3.66%", ecpm: "$88.90", revenue: "$38.12" },
        { date: "Mar 2, 2026", impressions: "13,456", clicks: "356", ctr: "2.65%", ecpm: "$89.22", revenue: "$83.43" },
