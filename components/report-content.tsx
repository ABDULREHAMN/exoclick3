...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 01, 2026", impressions: "9,880", clicks: "610", ctr: "6.17%", ecpm: "$140.31", revenue: "$45.35" },
        ...
        { date: "Mar 25, 2026", impressions: "12,322", clicks: "336", ctr: "2.73%", ecpm: "$89.44", revenue: "$82.44" },
