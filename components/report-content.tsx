...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 19, 2026", impressions: "14,270", clicks: "2,115", ctr: "14.83%", ecpm: "$499.00", revenue: "$580.00" },
        { date: "Apr 18, 2026", impressions: "35,280", clicks: "3,477", ctr: "9.85%", ecpm: "$485.00", revenue: "$915.00" },
