...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Mar 17, 2026", impressions: "7,280", clicks: "289", ctr: "3.97%", ecpm: "$83.86", revenue: "$37.33" },
        { date: "Mar 16, 2026", impressions: "12,380", clicks: "310", ctr: "2.50%", ecpm: "$82.35", revenue: "$83.35" },
