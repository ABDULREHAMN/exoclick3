...
const reportData = {
  "Last 7 Days": {
    "All Countries": {
      "All Devices": [
        { date: "Apr 20, 2026", impressions: "10,215", clicks: "435", ctr: "4.26%", ecpm: "$385.00", revenue: "$95.35" },
        { date: "Apr 19, 2026", impressions: "33,280", clicks: "3,333", ctr: "10.02%", ecpm: "$450.00", revenue: "$903.00" },
